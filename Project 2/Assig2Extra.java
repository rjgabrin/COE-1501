...
public class Assig2Extra
{
	public static void main(String [] args)
	{
        ...
        System.out.println("\tTESTING EXTRA CREDIT METHOD ARRAY_CHANGE_KEY_CASE():");
        System.out.println("\tInverts all character cases (upper to lower, lower to upper) of original key");
